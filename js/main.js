        var randomMove = ["rock", "paper", "scissors"];
        function getComputerMove() {
            //for (i = 0; i < wdi_16_names.length; i++) {
                var pick = Math.floor(Math.random() * randomMove.length);
                var movePicker = randomMove[pick];
                //var remove = wdi_16_names.indexOf(namePicker);
                //while (wdi_16_names.length > 1) {
                    //wdi_16_names.splice(remove, 1);
                    //return namePicker;
                //}
                return movePicker;
            //}
